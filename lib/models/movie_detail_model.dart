...
class MovieDetailModel {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'urlImages': urlImages,
      'relesedate': relesedate.millisecondsSinceEpoch,
      'overview': overview,
  ...
  factory MovieDetailModel.fromMap(Map<String, dynamic> map) {
    ...
    return MovieDetailModel(
      ...
      genres: List<GenereModel>.from(
          map['genres']?.map((x) => GenereModel.fromMap(x)) ?? const []),
      urlImages: urlImages,
      relesedate: DateTime.parse(map['release_date']),
